  ...
  return (
    <div className="contact-container">
      <Helmet>
        ...
        />
        <meta property="og:title" content="Contact - EzeBytes" />
        <meta
      ...
      <main className="contact-main">
          ...
          <div className="contact-max-width max-content-container">
            <div className="contact-content-container">
              <h1 className="contact-text heading1">
                <span className="contact-text01">EzeBytes</span>
                <span>
                  {' '}
              ...
              <div className="contact-input-container">
                <button className="contact-button button-primary button">
                  Lets Get Connected
                </button>
              </div>
              <div className="contact-features-container">
                ...
                <div className="contact-feature1">
                  <svg
                    viewBox="0 0 877.7142857142857 1024"
        ...
        <div className="contact-section-one section-container">
          <div className="contact-max-width1 max-content-container">
            <h2 className="contact-text08 heading2">
              <span>
              ...
              <span className="contact-text12">Marketing</span>
              <span>
                {' '}
        ...
        <div className="section-container">
          <div className="contact-max-width2 max-content-container">
            <div className="contact-image-container1">
              <img
                alt="image"
            ...
            <div className="contact-content-container1">
              <h1 className="contact-text14 heading2">
                <span>
                ...
                <span className="contact-text16">Always.</span>
              </h1>
              <span className="contact-text17 content-Light">
                <span>
        ...
        <div className="section-container">
          <div className="contact-max-width3 max-content-container">
            <div className="contact-content-container2">
              <h1 className="contact-text20 heading2">
                <span>
                ...
                <span className="contact-text22">In the morning.</span>
              </h1>
              <span className="contact-text23 content-Light">
                <span>
                  Amet minim mollit non deserunt ullamco est sit aliqua dolor do
                  amet sint. Velit officia consequat duis enim velit mollit.
                  Velit officia consequat duis enim velit mollit.
            ...
            <div className="contact-image-container2">
              <img
                alt="image"
        ...
        <div className="contact-section-four section-container">
          <div className="contact-max-width4 max-content-container">
            <h2 className="contact-text26 heading2">
              <span>People love Feedbox.</span>
              <br></br>
              <span className="contact-text28">So would you.</span>
              <span className="contact-text29"></span>
            </h2>
          </div>
          <div data-type="slider" className="contact-slider">
            <Slide></Slide>
            <Slide
        ...
        <div className="section-container">
          <div className="contact-max-width5 max-content-container">
            <div className="contact-heading-container">
              <h2 className="contact-text30 heading2">
                ...
                <span className="contact-text33">Feedbox.</span>
              </h2>
              <span className="content-Light">
                ...
                <span className="contact-text36"></span>
                <span>day!</span>
              </span>
            </div>
            <div className="contact-get-the-app">
              <img
                alt="image"
            ...
            <div className="contact-cards-container1">
        ...
        <div className="contact-section-six section-container">
          <div className="contact-max-width6 max-content-container">
            <div className="contact-content-container3">
              <h1 className="contact-text38 heading2">
                <span>Get started today.</span>
                <br></br>
                <span className="contact-text40">Try free for 30 days.</span>
              </h1>
              <span className="contact-text41 content-Light">
                Go to App Store, install Feedbox and start changing your reading
                habbits today!
              </span>
              <div className="contact-input-container1">
                <div className="contact-container1 input">
                  <svg
                ...
                <button className="contact-button1 button-primary button">
                  Get started
                </button>
              </div>
              <div className="contact-features-container1">
                <div className="contact-feature3">
                  <svg
                    viewBox="0 0 877.7142857142857 1024"
                ...
                <div className="contact-feature4">
                  <svg
                    viewBox="0 0 877.7142857142857 1024"
                ...
                <div className="contact-feature5">
                  <svg
                    viewBox="0 0 877.7142857142857 1024"
            ...
            <div className="contact-image-container3">
              <img
                alt="image"
